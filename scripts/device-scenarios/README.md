...
Do not invoke the older cellular-line repair shortcut from unattended network
transitions. Changing the default voice/data line can present iOS's blocking
