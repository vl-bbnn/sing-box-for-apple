...
class IPhoneWLTStabilityContractTests(unittest.TestCase):
    ...
    def test_core_wlt_memory_recovery_does_not_force_on_demand_for_manual_start(self):
        provider = (
        ...
        self.assertIn("if alwaysOn || onDemandEnabled", start)
        self.assertIn("useDefaultRules: alwaysOn", start)
        self.assertNotIn("whitelistTransportAutoRecovery", start)
